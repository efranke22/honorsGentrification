...
In this file I create Poisson regression models for Minneapolis and Saint Paul crime.
...
crimes_wide_minn %>%
  ...
  pivot_longer(cols = c(Violent, Theft), names_to = "crime_type", values_to = "Count") %>%
  ggplot(aes(x=Count))+
  geom_density()+
