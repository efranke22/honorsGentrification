...
Median home value of all owner occupied housing units H085001
Median contract rent H056001

```{r}
variables2000 <- load_variables(2000, "sf3")

census2000 <- get_decennial(year = 2000, state = "MN", geography = "tract", variables = c("P001001", "P053001", "P037015", "P037032", "H034001", "H034002", "H034003", "H034004", "H034005", "H034006", "H034007", "H034008", "H034009", "H034010", "H007001", "H007002", "H007003", "P006002", "H085001", "H056001"), output = 'wide') %>%
  ...
  rename("population" = "P001001", 
         ...
         "totalWhite" = "P006002", 
         "medianHomeValue" = "H085001", 
         "medianContractRent" = "H056001")
```
...
"B01003_001", "B06011_001", "B23006_023", "B25034_001", "B25034_002", "B25034_003", "B25034_004", "B25034_005", "B25034_006", "B25034_007", "B25034_008", "B25034_009", "B25034_010", "B25058_001", "B25107_001", "B25003_001", "B25003_002", "B25003_003", "B02001_002", "B25077_001"), output = 'wide') %>%
  filter(word(NAME, 4) %in% c("Hennepin", "Ramsey"))%>%
               mutate(tract = word(NAME, 3),
                      tract = str_remove(tract, ","),
                      county = word(NAME, 4)) %>%
