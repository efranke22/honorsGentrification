...
This file covers importing data using the Tidycensus package for variables that may of interest. 
...
census2000 <- get_decennial(year = 2000, state = "MN", geography = "tract", variables = c("P001001", "P053001", "P037015", "P037032", "H007001", "H007002", "H007003", "P006002", "H085001", "H056001"), output = 'wide') %>%
...
"B01003_001", "B19013_001", "B23006_023", "B25058_001", "B25107_001", "B25003_001", "B25003_002", "B25003_003", "B02001_002", "B25077_001"), output = 'wide') %>%
  filter(word(NAME, 4) %in% c("Hennepin", "Ramsey"))%>%
               mutate(tract = word(NAME, 3),
                      tract = str_remove(tract, ","),
                      county = word(NAME, 4)) %>%
