...
acs2015groups <- acs2015 %>%
  ...
  summarize(population_2015 = sum(population_2015),
            medianIncome_2015 = weighted.mean(medianIncome_2015, population),
            total25to64_2015 = sum(total25to64_2015),
            bachelors25to64_2015 = sum(bachelors25to64_2015),
            medContractRent_2015 = weighted.mean(medContractRent_2015, population),
            medianHomeValue_2015 = weighted.mean(medianHomeValue_2015, population, na.rm=TRUE), 
            tenureTotal_2015 = sum(tenureTotal_2015), 
            tenureOwned_2015 = sum(tenureOwned_2015),
            tenureRented_2015 = sum(tenureRented_2015), 
            totalRace_2015 = sum(totalRace_2015),
            totalWhite_2015 = sum(totalWhite_2015)) %>%
  summarize(across(where(is.double), round)) %>%
  mutate(grouped = c(249.04, 408.04, 1263.00)) %>%
...
acs2015clean <- acs2015 %>%
  mutate(tract_2015 = as.numeric(tract_2015)) %>%
  filter(!(tract_2015 %in% c(249.01, 249.02, 1023.00, 1029.00, 408.02, 408.03))) %>%
  select(GEOID_2015, population_2015, medianIncome_2015, total25to64_2015, bachelors25to64_2015, medContractRent_2015, medianHomeValue_2015, tenureTotal_2015, tenureOwned_2015, tenureRented_2015, totalRace_2015, totalWhite_2015, tract_2015, county_2015) %>%
  bind_rows(acs2015groups) %>%
  filter(tract_2015 != 9800.00)
```
