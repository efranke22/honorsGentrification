...
This is the 2nd file in my data cleaning and exploration process. In this file, I identify and deal with census tracts that changed borders from 2010 to 2020. 
...
final_condensed_msp <- bind_rows(a,b) %>%
  filter(!(tractmod %in% c(201.01, 201.02, 238.02, 236, 231, 229.01, 218, 217, 214, 212, 205, 204, 244, 247)))
```
