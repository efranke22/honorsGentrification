...
```{r}
final_condensed %>%
  ggplot(aes(x=total25to64_2010, y=total25to64_2020))+
  geom_point()

#regional change in share of adults with college degrees
final_condensed %>%
  ungroup() %>%
  summarize(avg_propbachelors2010 = mean(bachelors25to64_2010/total25to64_2010), 
         ...
         medIncChange = quantile((medianIncome_2020 - medianIncome_2010)/medianIncome_2010, 0.67))
```
