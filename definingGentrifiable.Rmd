...
This is the 3rd file in my data cleaning and exploration process. In this file I identify census tracts eligible to undergo gentrification. 
...
gentrifiable %>%
  ggplot()+
  geom_sf(aes(fill=canGent2010), lwd = 0.4)+
  geom_sf(data = roads_sub, fill = "gray",color = "gray", lwd= 0.5)+
  labs(title = "2010 gentrification eligibility in Minneapolis-Saint Paul census tracts", fill = "Eligible to gentrify", x = "", y = "")+
  scale_fill_manual(values = c("#898A99", "#C6431F"))+
