...
load("Data/tractData/originalTidycensus/dicennial2010.RData")
```
...
**NOTE: need to get rentOccupied and ownership information and race information from acs surveys and use it here**.
